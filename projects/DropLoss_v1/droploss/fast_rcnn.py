...
class DropLossFastRCNNOutputLayers(FastRCNNOutputLayers):
    """
...
class DropLossFastRCNNOutputs(FastRCNNOutputs):
    """
    ...
    def __init__(
        ...
        """
        super(DropLossFastRCNNOutputs, self).__init__(box2box_transform=box2box_transform,
